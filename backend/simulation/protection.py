...
from core.config import (
    ...
    PROT_BEARING_TEMP_TRIP_C, PROT_PRESSURE_HP_MAX_BAR, PROT_PRESSURE_HP_MIN_BAR, PROT_TEMP_HP_MAX_C,
...
class ProtectionSystem:
    ...
    def __init__(self):
        ...
        self._protections: dict[str, Protection] = {p.name: p for p in [
            ...
            Protection("HP_LOW_PRESSURE", "Perte source vapeur HP (< 49 bar)",     "TRIP",       delay_s=5.0),
    ...
    def _build_conditions(self, params, avr_controller, grid_connected_at=None) -> dict[str, bool]:
        ...
        return {
            ...
            "HP_LOW_PRESSURE": machine_moving and params.pressure_hp < PROT_PRESSURE_HP_MIN_BAR,
